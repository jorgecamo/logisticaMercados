        ...
        <table class="table table-striped" id="anyadirMercados">
            ...
            <tr>
                <td><input type="text" name="nombre" class="form-control"
                        placeholder="Introduce el nombre del nuevo mercado" pattern="^[A-Za-z0-9' .-]+$" required></td>
                <td>
                ...
                <td><input type="text" name="direccion" class="form-control"
                        placeholder="Introduce la direccion del nuevo mercado" pattern="^[A-Za-z0-9' .-]+$" required></td>
                <td><button type="submit" class="btn btn-primary">Añadir Mercado</button></td>
            </tr>
        </table>
    </form>
